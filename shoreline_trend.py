...
from .ndwi_processing import process_ndwi_function,getBandCount
...
class shorelineChange:
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg.multibandRasterComboboxNDWI.currentIndexChanged.connect(lambda:getBandCount(self.dlg))
